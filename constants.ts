...
export const DICTIONARY: Record<Language, Content> = {
  [Language.DE]: {
    ...
    workshops: {
      ...
      description: "Unsere Workshops finden in Kooperation mit traditionellen Ölmühlen (z.B. Son Catiu) auf Mallorca statt. Tauche ein in die Produktion und lerne, wie ein Profi zu verkosten.",
      locationLabel: "Ort",
  ...
  [Language.EN]: {
    ...
    varieties: {
      ...
      regions: [
        ...
        { name: "Mallorca (D.O. Oli de Mallorca)", desc: "Island oils, often Arbequina or Mallorquina variety, usually mild and fruity." }
      ]
    },
    knowledge: {
      title: "Knowledge Hub",
